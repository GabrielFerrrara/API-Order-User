...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler({ BindException.class, MethodArgumentNotValidException.class, OrderInvalidException.class })
    ...
    @ExceptionHandler({ OrderNotFoundException.class, NoHandlerFoundException.class, UserInvalidException.class })
